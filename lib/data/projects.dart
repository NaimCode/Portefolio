...
List<Project> PROJECTS = [
  ...
  Project(
    name: 'Hulu 2.0',
    description: "Copie de la plateforme de streaming Hulu",
    image: 'images/projects/hulu.jpeg',
    url: 'https://github.com/NaimCode/Hulu-2.0',
    skills: [
      'Next Js',
      'Node Js',
      'Postman',
  ...
  Project(
    name: 'Anime Founder',
    description: 'Un petit site pour chercher ses animes',
    image: 'images/projects/anime1.jpeg',
    url: 'https://github.com/NaimCode/NextJsApp',
    skills: [
      'JavaScript',
      'HTML',
      'CSS',
